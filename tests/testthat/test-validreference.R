#
#
#  Test for cxapp::cxapp_validreference()
#
#
#


#' @cx.testsfor cxapp::cxapp_validreference
...
testthat::test_that( "audit.validreference.paramMissing", {
  ...
  # -- test
  testthat::expect_false( cxapp::cxapp_validreference() )
...
testthat::test_that( "audit.validreference.paramNull", {
  ...
  # -- test
  testthat::expect_false( cxapp::cxapp_validreference( NULL ) )
...
testthat::test_that( "audit.validreference.paramInvalidType", {
  ...
  # -- test
  testthat::expect_false( cxapp::cxapp_validreference( TRUE ) )
...
testthat::test_that( "audit.validreference.paramInvalidReferences", {
  ...
  result <- cxapp::cxapp_validreference( test_references ) 
