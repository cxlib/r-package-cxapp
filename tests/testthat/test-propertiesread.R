...
testthat::test_that( "propread.nothingDefaults", {
  ...
  # - test
  result <- cxapp::cxapp_propertiesread()
...
testthat::test_that( "propread.nullDefaults", {
  ...
  # - test
  result <- cxapp::cxapp_propertiesread( NULL )
...
testthat::test_that( "propread.NADefaults", {
  ...
  # - test
  result <- cxapp::cxapp_propertiesread( NA )
...
testthat::test_that( "propread.fileNotExist", {
  ...
  # - test
  result <- cxapp::cxapp_propertiesread( file.path( test_root, "idonotexist.properties", fsep = "/") )
...
testthat::test_that( "propread.simpleCase", {
  ...
  # - test
  result <- cxapp::cxapp_propertiesread( test_file )
