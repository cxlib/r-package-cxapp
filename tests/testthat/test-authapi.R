...
testthat::test_that( "authapi.authBearerWildcardSecretsCached", {
  ...
  #   note: should result in cached token

  if ( ! cxapp::cxapp_authapi( test_authstring ) )
    testthat::fail( "Unexpected first authentication failed" )
